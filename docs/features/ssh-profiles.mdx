...
SSH profiles sync across Macs when iCloud Sync is enabled with the **SSH Profiles** toggle on in **Settings > Sync**. Passwords and key passphrases stay local by default. Turn on **Password sync** to sync credentials via iCloud Keychain.
