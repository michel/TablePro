...
<CardGroup cols={2}>
  ...
  <Card title="Appearance" icon="palette" href="/customization/appearance">
    Theme engine with 9 presets, custom themes, colors, and fonts
  </Card>
...
The font setting affects all data grid cells, including NULL placeholders and cell editing overlays. A live preview is shown in the settings panel.
...
Select a plugin to enable or disable it using the toggle in the detail pane. Disabled plugins hide their database type from the connection dialog and prevent connections to that database type.
...
| Setting | Location | Description |
|---------|----------|-------------|
| Theme | Appearance | 9 built-in presets + custom themes |
| Theme colors | Appearance | Editor syntax, data grid, UI, sidebar, toolbar colors |
| Theme fonts | Appearance | Editor and data grid font family/size (moved from Editor/Data Grid tabs) |
| Accent color | Appearance | UI accent color |
| Row height | Data Grid | Grid row height |
| Date format | Data Grid | Date display format |
| Font family | Data Grid | Monospace font for data cells |
| Font size | Data Grid | Data cell text size (10-18 pt) |
