...
TablePro uses [Sparkle](https://sparkle-project.org/) for secure, seamless updates. When an update is available, you'll see a dialog with release notes and the option to install.
