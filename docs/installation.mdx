...
<Warning>
This is normal for unsigned applications downloaded from the internet. TablePro is safe to use — the source code is source-available and publicly viewable for inspection.
</Warning>
