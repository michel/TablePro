...
<Tip>
Bạn cũng có thể kết nối trực tiếp bằng cách mở URL `mysql://` hoặc `mariadb://` từ trình duyệt hoặc terminal. Xem [Tham chiếu URL kết nối](/databases/connection-urls) để biết chi tiết.
</Tip>
...
<Tip>
Bạn cũng có thể kết nối trực tiếp bằng cách mở URL `mysql://` từ trình duyệt hoặc terminal. Xem [Tham chiếu URL kết nối](/databases/connection-urls) để biết thêm chi tiết.
</Tip>
