...
If you have a database URL, you can open it directly from your browser or terminal — TablePro will launch and connect immediately without any form or saved connection required.
