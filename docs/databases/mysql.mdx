...
<Tip>
You can also connect directly by opening a `mysql://` or `mariadb://` URL from your browser or terminal. See [Connection URL Reference](/databases/connection-urls) for details.
</Tip>
...
<Tip>
You can also connect directly by opening a `mysql://` URL from your browser or terminal. See [Connection URL Reference](/databases/connection-urls) for details.
</Tip>
