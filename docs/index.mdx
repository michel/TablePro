...
Get started: follow the [Quick Start Guide](/quickstart) to download TablePro and connect to your first database.
...
TablePro is free, source-available software. The source code is publicly viewable on GitHub for transparency.
