...
final class AppSettingsStorage {
    ...
    private enum Keys {
        static let general = "com.OpenTable.settings.general"
        static let appearance = "com.OpenTable.settings.appearance"
        static let editor = "com.OpenTable.settings.editor"
        static let dataGrid = "com.OpenTable.settings.dataGrid"
        static let history = "com.OpenTable.settings.history"
        static let lastConnectionId = "com.OpenTable.settings.lastConnectionId"
    }
