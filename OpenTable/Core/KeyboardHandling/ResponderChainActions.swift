...
//  OpenTable
//
//  Documentation protocol listing all responder chain actions used in OpenTable.
//  This is a reference guide, not implemented by any class directly.
//
//  ## Architecture Pattern
//
//  OpenTable uses Apple's native responder chain for keyboard shortcuts:
//
//  1. **SwiftUI Commands** define shortcuts (in OpenTableApp.swift)
...
//    ↓
//  OpenTableApp: NSApp.sendAction(#selector(delete(_:)), to: nil, from: nil)
//    ↓
...
//
//  ## Reference Files
//  - `OpenTableApp.swift` - SwiftUI Commands that define shortcuts
...
/// Documentation protocol listing all responder chain actions in OpenTable.
///
...
/*
 ...
 ### Step 3: Register Command in OpenTableApp.swift
