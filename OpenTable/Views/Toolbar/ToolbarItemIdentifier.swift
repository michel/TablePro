...
enum ToolbarItemIdentifier: String, CaseIterable {
    ...
    case connectionSwitcher = "com.OpenTable.toolbar.connectionSwitcher"

    /// Database switcher (switch to different database within current connection)
    case databaseSwitcher = "com.OpenTable.toolbar.databaseSwitcher"

    /// New query tab
    case newQueryTab = "com.OpenTable.toolbar.newQueryTab"

    /// Refresh current view/query
    case refresh = "com.OpenTable.toolbar.refresh"

    // MARK: - Center Section (Principal)

    /// Connection status display (tag + connection info + execution indicator)
    case connectionStatus = "com.OpenTable.toolbar.connectionStatus"

    // MARK: - Right Section (Actions)

    /// Toggle filter panel
    case filterToggle = "com.OpenTable.toolbar.filterToggle"

    /// Toggle query history panel
    case historyToggle = "com.OpenTable.toolbar.historyToggle"

    /// Export data
    case export = "com.OpenTable.toolbar.export"

    /// Import data
    case `import` = "com.OpenTable.toolbar.import"

    /// Toggle right sidebar (inspector)
    case inspector = "com.OpenTable.toolbar.inspector"
