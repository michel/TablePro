...
extension MainContentCoordinator {
    ...
    func createView() {
        ...
        tabManager.addTab(initialQuery: template, databaseName: connection.database)
    }
    ...
    func editViewDefinition(_ viewName: String) {
        Task { @MainActor in
            do {
                ...
                tabManager.addTab(initialQuery: definition, databaseName: connection.database)
            } catch {
                ...
                tabManager.addTab(initialQuery: fallbackSQL, databaseName: connection.database)
            }
        }
    }
